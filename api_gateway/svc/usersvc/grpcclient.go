...
var _ user.Service = (*grpcClient)(nil)
...
func (c *grpcClient) Find(ctx context.Context) ([]*user.User, error) {
	rsp, err := c.findEndpoint(ctx, nil)
	if err != nil {
		return nil, err
	}
...
func (c *grpcClient) Get(ctx context.Context, id int64) (*user.User, error) {
